...
| 5  | Electrical Components for each PCB | ~$100 (with shipping, cost can vary widely however) | See BOM for a full list, the PCB fabrication files automatically include these components as well.
