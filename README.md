...
| 5  | Electrical Components for each PCB | ~$200 (this is on the high end, cost can vary widely) | See production BOM for a full list, the PCB fabrication files automatically include these components as well.
Total: $245.32
